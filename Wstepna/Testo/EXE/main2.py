...
def wybierz_styl_z_pliku():
    ...
    if os.path.isfile("Styl.txt"):
        ...
        with open("Styl.txt", "r", encoding='utf-8') as plik:
            ...
            if os.path.isfile(f"styl_{styl}.css"):
                ...
                try:
                    ...
                    url = f"https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/EXE/Style/styl_{styl}.css"
        ...
        try:
            ...
            url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/EXE/Style/styl_szarość.css"
...
class AutoStartManager:
    ...
    def find_main2_folder(self):
        ...
        for root, dirs, files in os.walk(desktop_path):
            if 'main2.exe' in files and 'rei' in dirs:
    ...
    def run(self):
        # Szukaj folderu zawierającego main2.exe i folder rei
        main2_folder = self.find_main2_folder()

        if main2_folder:
            print("Znaleziono folder zawierający main2.exe i folder rei:", main2_folder)

            # Ścieżka do pobrania pliku Automa.exe
            automa_url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/EXE/Automa.exe"
            ...
            print("Nie znaleziono folderu zawierającego main2.exe i folder rei.")
...
class Ikona:
    def tworzenie_ikonki(self):
        def find_folders_with_main2_and_rei(desktop_path):
            # Lista przechowująca ścieżki do folderów, w których znaleziono plik main2.exe i folder rei
            folders_found = []

            # Przeszukaj wszystkie foldery na pulpicie
            for root, dirs, files in os.walk(desktop_path):
                if "main2.exe" in files and "rei" in dirs:
                    # Znaleziono folder zawierający zarówno plik main2.exe, jak i folder rei
        ...
        def select_folder_and_create_shortcut():
            ...
            # Znajdź foldery zawierające zarówno plik main2.exe, jak i folder rei
            ...
            # Utwórz skrót na pulpicie do pliku main2.exe w wybranym folderze
            create_shortcut(os.path.join(selected_folder_path,
                            "main2.exe"), "Magnesy", icon_path)
...
def Inne():
    ...
    def Inne1p():
        try:  # Tego pliku nie ma w repozytorium
            subprocess.run(['python', 'Inne.exe'])
        except:
            pass
...
def download_icon():
    try:
        ...
        url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/EXE/icon.ico"
...
def sprawdzanie_nowych_aktualizacji():
    ...
    while True:
        try:
            ...
            try:
                url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/EXE/version.txt'
                response = requests.get(url)
                    ...
                    if os.path.exists(sciezka_info):
                        with open(sciezka_info, 'r', encoding='utf-8') as plik_info:
                            ...
                            przycisk.clicked.connect(uruchom_skrypt(
                                os.path.join(sciezka_folderu, f"{nazwa_skryptu}.exe")))
...
class OknoAktualizacji(QWidget):
    def __init__(self):
        ...
        self.urls = [
            "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/EXE/version.txt",
            "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/EXE/Klienci.exe",
            "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/EXE/main2.exe"
    ...
    def zakoncz_aktualizacje(self, value):
        ...
        if value == 100:
            # Tutaj dodano uruchomienie programu z nowego pliku main.exe po zakończeniu aktualizacji
            # subprocess.run(["python", "Aktualizator.exe"])
            # Uruchomienie programu z nowego pliku main2.exe po zakończeniu aktualizacji
            os.execl(sys.executable, sys.executable, "main2.exe")
...
''', zakladka)
    ...
    def automa(self):
        if messagebox.askokcancel("Autostart", 'Ta opcja doda aktualizator do autostartu, możesz to cofnąć w każdej chwili\nW niektórych przypadkach możesz zobaczyć okno terminala na killka sekund'):
            ...
            # Kolorowe instrukcje
            print(f"{Fore.LIGHTBLACK_EX}Aby wyłączyć - usuń plik {Fore.LIGHTYELLOW_EX}Magnesy-autostart.bat{Style.RESET_ALL}{Fore.LIGHTBLACK_EX} z tej ścieżki:\n{sciezka_do_kasowania}{Fore.LIGHTBLACK_EX}\nPamiętaj o uzupełnieniu nazwy użytkownika ({Fore.BLUE}{getpass.getuser()}{Style.RESET_ALL}{Fore.LIGHTBLACK_EX})\nEwentualnie usuń {Fore.LIGHTYELLOW_EX} Magnesy-autostart.bat{Style.RESET_ALL}{Fore.LIGHTBLACK_EX} z autostartu w menedżerze zadań\n")
        else:
    ...
    def otworz_odbiorca(self):
        def w_nowym_watku():
            toaster = Powiadomienia()
            toaster.powiadomienie_jednorazowe(
                tytul_powiadomienia="Taa opcja jest niedostępna", tresc_powiadomienia="Niektóre funkcje są niedostępne w tej wersji", duration=3)
    ...
    def klienci(self):
        try:
            ...
            subprocess.run(['python', 'Klienci.exe'])
        except:
            pass
