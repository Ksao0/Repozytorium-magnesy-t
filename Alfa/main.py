...
def taj():
    ...
    if version_online_2_line == 'Poprawka wersji' or version_online_2_line == 'Poprawka' or version_online_2_line == 'Status: Poprawka wersji' and version_local_first_line == version_online_first_line:
