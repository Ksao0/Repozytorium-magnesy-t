...
def czynnosci_poczatkowe():
    try:
        ...
        try:
            ...
            url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Stara/WEW.py"
...
def taj():
    try:
        ...
        try:
            url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Stara/version.txt'
        ...
        try:
            url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Stara/lista_b.txt'
            response = requests.get(url)
            response.raise_for_status()  # sprawdź, czy nie było błędu w pobieraniu
        ...
        if version_local != "BRAK DANYCH":
            ...
            if version_online_lines[0] != version_local_lines[0] and (version_online_lines[4] == version_local_lines[4] and lista_b_online == lista_b_local):
                ...
                message = f"Dostępna jest nowa wersja programu: {
                    version_online_lines[0]}. Czy chcesz ją teraz zainstalować?"
    ...
    try:
        if not internet == 0:
            ...
            if not internet == 0:
                ...
                url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Stara/Aktualizator_aktualizatora.py"
                urllib.request.urlretrieve(url, path)
...
if internet == 1:
    ...
    url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Stara/ikona_magnesy.ico'
...
def Gra_snake():
    try:
        ...
        try:
            ...
            url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Stara/Snake.py"
            urllib.request.urlretrieve(url, path)
            Gra = ["python", "Snake.py"]
            subprocess.run(Gra)
        except:
