...
import threading
import sys
nazwa_aplikacji = "Magnesia"
sciezka_do_ikony = "rei2/ikona_magnesy2.ico"


# Ewentualny kod powtarzalnych zgłoszeń

# Tutaj możesz umieścić resztę kodu, który ma działać równocześnie z powiadomieniami
while True:
    ...
    def powiadomienie_jednorazowe(tytul_powiadomienia, tresc_powiadomienia):
        ...
        def powiadomienie_w_tle():
            ...
            toaster.show_toast(title=f"{nazwa_aplikacji} - {tytul_powiadomienia}", msg=tresc_powiadomienia, icon_path=sciezka_do_ikony, duration=10)
