        ...
        def wersja():
            try:
                ...
                version_online = requests.get(
                    'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/w_exe/version.txt').text.strip()

                version_opis = requests.get(
                    'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/w_exe/version_o.txt').text.strip()
...
Zainstaluj biblioteki, a następnie utwórz folder w którym będą:
    - folder rei
    - plik main.exe (pamiętaj o odpowiednim rozszerzeniu pliku)
...
może być w innych folderach.
        ...
        def zainstaluj_biblioteki():
            ...
            try:
                ...
                libraries_to_install = requests.get(
                    'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/w_exe/bib.txt').text.strip().split()
        ...
        def aktualizacja():
            ...
            lista_txt_url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Wstepna/Testo/w_exe/lista.txt"
