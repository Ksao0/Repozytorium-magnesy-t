...
while True:
    time.sleep(1)  # Dodatkowe opóźnienie, aby uniknąć intensywnego użycia CPU
        ...
        # Funkcja od obsługi powiadomień
    def powiadomienie_jednorazowe(tytul_powiadomienia, tresc_powiadomienia):
        class MyToastNotifier(ToastNotifier):

            title = f"Magnesia - {tytul_powiadomienia}"

            def __init__(self, *args, **kwargs):
                super().__init__(*args, **kwargs)
                self.wyswietlone_powiadomienie = False

            def show_toast(self, msg, icon_path=None, duration=5, threaded=True):
                ...
                try:
                    if not self.wyswietlone_powiadomienie:
                        if not threaded:
                            ...
                            threading.Thread(target=self._show_toast, args=(title, msg, icon_path, duration)).start()
    ...
    def download_icon():
        try:
            ...
            url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/ikona_magnesy2.ico"
    ...
    def restart_program():
        ...
        try:
            ...
            url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/WEW.py"
                ...
                if not internet == 0:
                    ...
                    if okno_problemu_otwarte == 0:
                        ...
                        def zglos_problem_wyslij():
                            ...
                            tytul_powiadomienia_nowe = "Zgłoszenie wysłane!"
                            tresc_powiadomienia_nowe = "Twoje zgłoszenie zostało wysłane, wkrótce powinno zostać rozpatrzone"
    ...
    def czynnosci_poczatkowe():
        try:
            ...
            try:
                url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/reia.txt'
                response = requests.get(url)
    ...
    def taj():
        try:
            try:
                ...
                url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/prefvers.txt'
                response = requests.get(url)
                response.raise_for_status()  # sprawdź, czy nie było błędu w pobieraniu
            ...
            try:
                url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/version.txt'
                response = requests.get(url)
                response.raise_for_status()  # sprawdź, czy nie było błędu w pobieraniu
            ...
            try:
                url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/lista_b.txt'
                response = requests.get(url)
                response.raise_for_status()  # sprawdź, czy nie było błędu w pobieraniu
            ...
            try:
                ...
                url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/nprefvers.txt'
                response = requests.get(url)
                response.raise_for_status()  # sprawdź, czy nie było błędu w pobieraniu
            ...
            try:
                ...
                if not internet == 0:
                    ...
                    if okno_informacje_otwarte == 0:
                        ...
                        try:
                            url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/Dziennik_b.txt'
                            response = requests.get(url)
                            response.raise_for_status()  # sprawdź, czy nie było błędu w pobieraniu
            ...
            while zrobione == False:
                try:
                    ...
                    if os.path.exists(path):
                        os.remove(path)
                    # Pobierz plik Aktualizator_aktualizatora.py z repozytorium
                    url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/Aktualizator_aktualizatora.py"
                    urllib.request.urlretrieve(url, path)
                    zrobione = True
                except:
                    zrobione = True
    ...
    if internet == 1:
        if blokada_bledu == True:
            ...
            if version_local != "BRAK DANYCH":
                ...
                # pobierz zawartość pliku version.txt z repozytorium na GitHub
                url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/Komunikat_yN.txt'
                response = requests.get(url)
        ...
        url = 'https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/ikona_magnesy.ico'
                    ...
                    if funkcja_eksperyment_1 != "Nie":
                        try:
                            ...
                            try:
                                ...
                                url = "https://raw.githubusercontent.com/Ksao0/Repozytorium-magnesy-t/main/Poprzednie/Nowa/Androidow.py"
                                urllib.request.urlretrieve(url, path)
